...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--csv_pdf_graph', type=str)
    ...
    def handle(self, *args, **options):
        ...
        models = dict()
        try:
            with open(options['csv_pdf_graph']) as csvfile:
            ...
            raise CommandError('File "{}" does not exist'.format(options['csv_pdf_graph']))
